...
\begin{figure*}[!t]\centering\begin{tikzpicture}\begin{axis}[width=.85\textwidth,height=7cm,xmin=-.6,xmax=2.6,ymin=-20,ymax=60,xtick={0,1,2},xticklabels={Short,Medium,Long},ylabel={Paired runtime change (\%)},legend style={at={(.5,1.05)},anchor=south,legend columns=2,font=\small},ymajorgrids=true]
