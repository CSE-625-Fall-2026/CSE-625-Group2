...
\end{column}
\begin{column}{.30\paperwidth}
\begin{block}{V8 Runtime AI vs Planned}
\centering\renewcommand{\plotheight}{18cm}\input{figures/v8_environments.tex}
...
\centering\renewcommand{\plotheight}{17cm}\input{figures/pthreads_means.tex}
\par\raggedright\small
